...
ViperCoreStylesPlugin.prototype = {
    ...
    start: function()
    {
        ...
        if (this.toolbarPlugin) {
            ...
            dfx.foreach(shortcuts, function(type) {
                ...
                ViperPluginManager.addKeyPressListener(keys, this, function() {
    ...
    {
        ViperUndoManager.begin();
        this.viper.surroundContents(tag);
        ViperUndoManager.end();
...
dfx.noInclusionInherits('ViperCoreStylesPlugin', 'ViperPlugin', true);
