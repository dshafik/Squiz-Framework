...
function ViperTableEditorPlugin(viper)
{
    ...
    ViperPluginManager.addKeyPressListener('TAB', this, 'handleTab');
    ViperPluginManager.addKeyPressListener('SHIFT+TAB', this, 'handleTab');
...
ViperTableEditorPlugin.prototype = {
    ...
    start: function()
    {
        ...
        ViperPluginManager.addKeyPressListener('DELETE', this, 'handleDelete');

        dfx.removeEvent(document, 'click.TableEditorPlugin');
        dfx.addEvent(document, 'click.TableEditorPlugin', function(e) {
            if (ViperPluginManager.getActivePlugin() === 'TableEditor') {
    ...
    hideCellButtons: function(noDisable)
    {
        try {
            ...
            if (noDisable !== true) {
                ViperPluginManager.setActivePlugin(null);
                ViperPluginManager.getPlugin('ViperSubToolbarPlugin').hideToolbar('TableEditor');
            }
        } catch (e) {
    ...
    showCellButtons: function(cell, noSet)
    {
        ...
        if (noSet !== true) {
            ViperPluginManager.setActivePlugin('TableEditor');
            // Text can be changed while this plugin is active.
            ViperPluginManager.allowTextInput = true;
        }
        ...
        if (!this._subToolbar) {
            ...
            var subToolbarPlugin = ViperPluginManager.getPlugin('ViperSubToolbarPlugin');
            if (subToolbarPlugin) {
    ...
    removeTable: function(table, emptyOnly)
    {
        if (emptyOnly === true) {
            ...
            if (dfx.getTag('td', table).length > 0 || dfx.getTag('th', table).length > 0) {
                return;
            }
        }
    ...
    _setupCellProperties: function(callback)
    {
        ...
        var optsList = ViperPluginManager.getPlugin('ViperSubToolbarPlugin').createOptionsList('Appearance');
    ...
    _showProperties: function(type)
    {
        ...
        ViperPluginManager.getPlugin('ViperSubToolbarPlugin').showToolbar('TableEditor');
...
dfx.noInclusionInherits('ViperTableEditorPlugin', 'ViperPlugin', true);
