...
ViperFormatPlugin.prototype = {
    ...
    start: function()
    {
        ...
        var button = this.toolbarPlugin.addButton(name, 'format', 'Format', function (e) {
            // Add document click event for hiding the menu.
            dfx.addEvent(document, 'click.ViperFormatPlugin', function() {
                dfx.setStyle(menu, 'display', 'none');
                self._range = null;
                dfx.removeEvent(document, 'click.ViperFormatPlugin');
            });
...
dfx.noInclusionInherits('ViperFormatPlugin', 'ViperPlugin', true);
